  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="glass-panel relative rounded-[34px] p-6 sm:p-8">
          {createMutation.isPending ? <LoadingOverlay label="Creating campaign..." /> : null}
          <p className="eyebrow text-smoke">Launch a campaign</p>
          <h1 className="mt-3 font-display text-5xl leading-none text-ink">Create your Crowdit page</h1>
          <p className="mt-4 text-base leading-8 text-smoke">
            Write a strong brief, set the XLM target, and choose the exact moment this drop closes.
          </p>
          {!session?.address ? (
